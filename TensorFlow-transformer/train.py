...
from data_load import get_batch_data, load_chi_vocab, load_en_vocab
from modules import *
...
class Graph():
    def __init__(self, is_training=True):
        ...
        with self.graph.as_default():
            ...
            if is_training:
                # Loss
                self.y_smoothed = label_smoothing(tf.one_hot(self.y, depth=len(chi2idx)))
